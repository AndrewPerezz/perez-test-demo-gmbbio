...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
            name: TeamDetailPageWidget.routeName,
            path: TeamDetailPageWidget.routePath,
            builder: (context, params) => NavBarPage(
                  initialPage: '',
                  page: TeamDetailPageWidget(
                    amountInvested: params.getParam(
                      'amountInvested',
                      ParamType.String,
                    ),
                    categoryFilter: params.getParam(
                      'categoryFilter',
                      ParamType.String,
                    ),
                    genderFilter: params.getParam(
                      'genderFilter',
                      ParamType.String,
                    ),
                    sharkId: params.getParam(
                      'sharkId',
                      ParamType.int,
                    ),
                    avatarSize: params.getParam(
                      'avatarSize',
                      ParamType.double,
                    ),
                  ),
        ...
        FFRoute(
            name: LiveStreamListWidget.routeName,
            path: LiveStreamListWidget.routePath,
            builder: (context, params) => NavBarPage(
                  initialPage: '',
                  page: LiveStreamListWidget(),
                )),
        FFRoute(
        ...
        FFRoute(
            name: MyHandicapWidget.routeName,
            path: MyHandicapWidget.routePath,
            builder: (context, params) => NavBarPage(
                  initialPage: '',
                  page: MyHandicapWidget(),
                )),
        FFRoute(
            name: MyBagWidget.routeName,
            path: MyBagWidget.routePath,
            builder: (context, params) => NavBarPage(
                  initialPage: '',
                  page: MyBagWidget(),
                )),
        ...
        FFRoute(
            ...
            builder: (context, params) => NavBarPage(
                  initialPage: '',
                  page: MasterPageWidget(),
                )),
        FFRoute(
            name: TournamentsWidget.routeName,
            path: TournamentsWidget.routePath,
            builder: (context, params) => NavBarPage(
                  initialPage: '',
        ...
        FFRoute(
            ...
            builder: (context, params) => NavBarPage(
                  initialPage: '',
                  page: LiveStreamerWidget(),
                )),
        FFRoute(
            name: LiveStreamWidget.routeName,
            path: LiveStreamWidget.routePath,
            builder: (context, params) => NavBarPage(
                  initialPage: '',
                  page: LiveStreamWidget(),
                )),
        FFRoute(
          name: EnterScoreWidget.routeName,
          path: EnterScoreWidget.routePath,
          builder: (context, params) => EnterScoreWidget(),
        )
