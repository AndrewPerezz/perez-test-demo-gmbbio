...
class TournamentsWidget extends StatefulWidget {
  const TournamentsWidget({super.key});

  static String routeName = 'Tournaments';
  static String routePath = '/tournaments';
...
class _TournamentsWidgetState extends State<TournamentsWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Tournaments'});
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('TOURNAMENTS_PAGE_menu_sharp_ICN_ON_TAP');
